	...
	$.fn.fullpage = function(options) {
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				if(startingSlide.length == 0){
					slides.eq(0).addClass('active inview');
				}
			...
			if(options.navigation){
				...
				nav.find('li').eq($('.fp-section.active').index('.fp-section')).find('a').addClass('active inview');
			}
			...
			if(destiny.length){
				...
				if(!options.animateAnchor && section.length){
					...
					section.addClass('active inview').siblings().removeClass('active inview');
				}
			}
		...
		function scrollHandler(){
			...
			if(!options.autoScrolling){
				...
				if(!currentSection.hasClass('active')){
					...
					currentSection.addClass('active inview').siblings().removeClass('active inview');
		...
		*/
		function scrollPage(element, callback, isMovementUp){
			...
			element.addClass('active inview').siblings().removeClass('active inview');
		...
		*/
		function landscapeScroll(slides, destiny){
			...
			destiny.addClass('active inview').siblings().removeClass('active inview');
			...
			slidesNav.find('.active inview').removeClass('active inview');
			slidesNav.find('li').eq(slideIndex).find('a').addClass('active inview');
		}
		...
		*/
		...
		function activateNavDots(name, sectionIndex){
			if(options.navigation){
				$('#fp-nav').find('.active').removeClass('active inview');
				if(name){
					$('#fp-nav').find('a[href="#' + name + '"]').addClass('active inview');
				}else{
					$('#fp-nav').find('li').eq(sectionIndex).find('a').addClass('active inview');
				}
			}
		}
		...
		function activateMenuElement(name){
			if(options.menu){
				$(options.menu).find('.active').removeClass('active inview');
				$(options.menu).find('[data-menuanchor="'+name+'"]').addClass('active inview');
			}
		}
		...
		*/
		function scrollPageAndSlide(destiny, slide){
			...
			if (destiny !== lastScrolledDestiny && !section.hasClass('active inview')){
		...
		*/
		function addSlidesNavigation(section, numSlides){
			...
			nav.find('li').first().find('a').addClass('active inview');
		}
